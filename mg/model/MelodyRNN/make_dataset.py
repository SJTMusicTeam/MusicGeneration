...
option = "giant_midis"#['giant_midis','maestro']

data_train_url = "../../egs/dataset/"+option+"/train"
data_vaild_url = "../../egs/dataset/"+option+"/vaild"
data_test_url = "../../egs/dataset/"+option+"/test"
save_url = "../../egs/dataset/"+option+"/"
...
np.savez(save_url+'vaild_dataset.npz', vaild=dataset)
dataset = creat_dataset(data_test_url)
np.savez(save_url+'test_dataset.npz', test=dataset)
dataset = creat_dataset(data_train_url)
np.savez(save_url+'train_dataset.npz', train=dataset)
